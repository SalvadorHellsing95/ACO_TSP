...
beta = 2; %constance of distance weight
evRate = 0.3; %Evaporation Rate
...
%OCTAVE
plot3(xBest, yBest, zBest, '-ro','xdatasource', 'xBest', 'ydatasource', 'yBest', 'zdatasource', 'zBest');
